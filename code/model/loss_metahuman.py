...
class Loss(nn.Module):
    ...
    def forward(self, model_outputs, ground_truth):
        ...
        if self.depth_weight > 0:
            depth_loss_head = self.get_l1_depth_loss(model_outputs['depth_values_head'], ground_truth['depth'], pred_head_mask, model_outputs['head_mask'])
    ...
    def cal_contact_loss(self, model_outputs):
        ...
        if 'nonrigid_dir' in model_outputs.keys():
            ...
            nonrigid_dir_loss = nonrigid_dir_loss * self.lbs_weight * 100.0 #* 10.0 
