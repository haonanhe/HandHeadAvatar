...
class Loss(nn.Module):
    ...
    def get_depth_loss(self, predicted_depth, depth, network_object_mask, head_mask):
        ...
        return self.depth_loss(predicted_depth[None, :, None], depth[None, :, None], mask[None, :, None])
    ...
    def forward(self, model_outputs, ground_truth):
        ...
        if self.depth_weight > 0:
            depth_loss_head = self.get_depth_loss(model_outputs['depth_values_head'], model_outputs['depth'], pred_head_mask, model_outputs['head_mask'])
