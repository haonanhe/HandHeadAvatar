...
class HHAvatar(nn.Module):
    ...
    def forward(self, input, return_sdf=False):
        ...
        verts_head, pose_feature, transformations = self.FLAMEServer(expression_params=expression, full_pose=flame_pose)
        ...
        if not optimize_contact or not self.training:
